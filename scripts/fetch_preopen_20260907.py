# -*- coding: utf-8 -*-
"""盘前档 2026-09-07(周一) 行情抓取：场外基金净值增量(9/4周五净值, 周一早盘全量可抓, QDII T+1~T+2至9/3) + 美股已归档(9/4美东周五收盘9/6已抓, 9/7劳动节休市无新数据)"""
...
# ---------- 1. 场外基金净值增量（9/4 周五净值，周一早盘全量可抓，QDII T+1~T+2 至 9/3） ----------
fund_map = {
...
# ---------- 2. 美股：9/4(美东周五)收盘 9/6 已归档，9/7 劳动节休市，无需新抓（保留尝试，已存在自动 SKIP） ----------
...
# ---------- 4. A股指数盘前尝试（上证/中证消费/创业板，9/4 收盘值） ----------
print('\n--- A股指数 spot 盘前 ---')
try:
