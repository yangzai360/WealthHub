# -*- coding: utf-8 -*-
"""盘前档 2026-09-15(周二) 行情抓取:
1) 场外基金净值增量(9/14 周一净值, 周二早盘 A股类全量可抓; QDII 应更新至 9/11)
2) 美股(美东 9/14 周一收盘 = 隔夜)
3) 港股 hq 直连(带 Referer, 9/14 收盘值) + A股指数日线(9/14 收盘)
4) 且慢 pmdj 复测
"""
