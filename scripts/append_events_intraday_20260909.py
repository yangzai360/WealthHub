# -*- coding: utf-8 -*-
"""2026-09-09 盘中: 事件库追加 8 条盘中新闻 (id 016-023) + 历史匹配统计"""
import json, os, glob
...
print(f"events-2026-09-09.json 共 {len(combined)} 条 (盘前{len(existing)} + 盘中{len(new_events)})")
for e in new_events:
