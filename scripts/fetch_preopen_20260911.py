# -*- coding: utf-8 -*-
"""盘前档 2026-09-11(周五) 行情抓取:
1) 场外基金净值增量(9/10 周四净值, 周五早盘全量可抓; QDII T+1~T+2 应更新至 9/9=XLV -0.33%)
2) 美股(美东 9/10 周四收盘: PPI 落地 + 欧央行加息 + 甲骨文财报)
3) 港股/A股 spot(返回 9/10 收盘值)
4) 且慢 pmdj 复测
"""
...
# ---------- 1. 场外基金净值增量(9/10 周四净值; QDII 9/9 应出=XLV -0.33% 兑现) ----------
fund_map = {
...
# ---------- 2. 美股: 美东 9/10(周四)收盘, 北京时间 9/11 早间抓取 ----------
