# -*- coding: utf-8 -*-
"""盘前档 2026-09-09(周三) 行情抓取:场外基金净值增量(9/8周二净值, 周三早盘全量可抓, QDII T+1~T+2) + 美股(美东9/8劳动节后重开收盘) + spot"""
...
# ---------- 1. 场外基金净值增量(9/8 周二净值, 周三早盘全量可抓, QDII T+1~T+2) ----------
fund_map = {
...
# ---------- 2. 美股: 美东 9/8(周二)劳动节后重开收盘, 北京时间 9/9 早间抓取 ----------
