# -*- coding: utf-8 -*-
"""2026-09-23 盘中档：新浪 hq 直连「两次调用拿全」（§3.84 推荐做法）
...
⚠️ §3.96：sh000922（中证红利）已连续两档空值 → 本档永久移出批量请求，改以 515180 代理
"""
...
json.dump(out, open(os.path.join(ROOT, "data/processed/history/intraday_hq_20260923.json"), "w",
                    encoding="utf-8"), ensure_ascii=False, indent=1)
print("已保存 intraday_hq_20260923.json")
