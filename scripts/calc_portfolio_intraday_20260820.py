# -*- coding: utf-8 -*-
"""2026-08-20 盘中: 组合当日收益估算（场外基金用赛道ETF盘中涨跌近似）+ 赛道敞口"""
import json, os

base = "/Users/jieyang/Documents/WealthHub"

# 8/20 盘中涨跌（%）：场内ETF实时 + 指数盘中（13:45 抓取）
intraday = {
    # 场内ETF
    "513050": 1.71, "159928": 0.45, "512170": 4.65, "513180": 1.02,
    "159920": 1.00, "512880": -0.28, "512980": 1.12, "515180": 0.21,
    "159938": 2.84,
    # 指数
    "sh000001": -0.01, "sz399006": 0.22, "sh000932": 0.26,
    "HSTECH": 1.50, "HSI": 1.34,
    # 美股(8/19收盘, QDII 8/21-22 才兑现, 今日盘中按 0)
    "XLV": 0.0, "IYH": 0.0,
}
...
def approx_pct(code, name):
    ...
    if code in ("000369", "016280"):
        return intraday["IYH"]          # 美股医药QDII -> IYH(8/17)
    if code in ("000071",):
...
with open("/tmp/portfolio_intraday_20260820.json", "w", encoding="utf-8") as f:
    json.dump(out, f, ensure_ascii=False, indent=2)
print("\n已存 /tmp/portfolio_intraday_20260820.json")
