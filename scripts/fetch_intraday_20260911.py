# -*- coding: utf-8 -*-
"""
盘中行情抓取 (2026-09-11 13:45 档)
源: akshare 新浪源 + 天天基金源 (东财 push2 已被代理拦截, 不适用)
输出: data/processed/history/{indices,etf_intraday,fund_nav}.csv (增量) + intraday_20260911.json
"""
...
try:
    ...
    want = {"000001": "上证指数", "399006": "创业板指", "000932": "中证消费", "000300": "沪深300"}
...
with open(os.path.join(HIST, "intraday_20260911.json"), "w", encoding="utf-8") as f:
