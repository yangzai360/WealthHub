# -*- coding: utf-8 -*-
"""盘前档 2026-08-31:DeepSeek 情绪标注 8/31 盘前新闻(17条)"""
import json, urllib.request, re

NEWS_PATH = '/Users/jieyang/Documents/WealthHub/data/processed/news/news-2026-08-31.json'
SENT_PATH = '/Users/jieyang/Documents/WealthHub/data/processed/news/sentiment-2026-08-31.json'
...
print(f'news JSON 情绪字段已同步 ({len(news2)} 条)')
