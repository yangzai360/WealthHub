# -*- coding: utf-8 -*-
"""2026-09-01 盘中: 组合当日收益估算（8/31 收盘市值为基准 + 盘中实时涨跌）+ 赛道敞口"""
import json, os

base = "/Users/jieyang/Documents/WealthHub"

# 9/1 盘中涨跌（%）：场内ETF实时 + 指数盘中（13:44 抓取）
intraday = {
    # 场内ETF
    "513050": -1.95, "159928": 1.35, "512170": 0.59, "513180": -1.03,
    "159920": -0.60, "512880": 0.90, "512980": 1.43, "515180": 0.54,
    "159938": 0.16,
    # 指数
    "sh000001": 0.04, "sz399006": -0.87, "sh000932": 1.25,
    "HSTECH": -1.04, "HSI": -1.12,
    # 美股(8/31 XLV -0.36% 于 9/2-3 兑现, 盘中估算按 0)
    "XLV": 0.0, "IYH": 0.0,
}

# 持仓基准: 8/31 收盘口径市值 (portfolio_preopen_20260901.json)
with open(os.path.join(base, "data/processed/history/portfolio_preopen_20260901.json"), encoding="utf-8") as f:
    preopen = json.load(f)
...
with open("/tmp/portfolio_intraday_20260901.json", "w", encoding="utf-8") as f:
    json.dump(out, f, ensure_ascii=False, indent=2)
print("\n已存 /tmp/portfolio_intraday_20260901.json")
