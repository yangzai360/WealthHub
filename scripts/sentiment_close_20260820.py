# -*- coding: utf-8 -*-
"""盘后档 2026-08-20：DeepSeek 情绪标注盘后新增 8 条 + 合并全量 29 条，track 手动指定"""
import json, os, urllib.request, time

BASE = '/Users/jieyang/Documents/WealthHub'
NEWS = os.path.join(BASE, 'data/processed/news/news-2026-08-20.json')
SENT = os.path.join(BASE, 'data/processed/news/sentiment-2026-08-20.json')
