# -*- coding: utf-8 -*-
"""2026-09-14 盘后: 链路累计/W38周累计/夏普比率/最大回撤（date 缺失时从文件名推导 §3.55）"""
...
out = {'date': '2026-09-14', 'chain_cum_pct': round((cum-1)*100, 2), 'chain_days': len(rows),
...
json.dump(out, open(os.path.join(HIST, 'risk_stats_20260914.json'), 'w', encoding='utf-8'), ensure_ascii=False, indent=1)
print('\n已保存 risk_stats_20260914.json')
