# -*- coding: utf-8 -*-
"""盘前档 2026-09-08(周二) 行情抓取:场外基金净值增量(9/7周一净值, 周二早盘全量可抓, QDII T+1~T+2) + 美股(9/7美东劳动节休市, 9/4已归档, 预计无新增) + spot"""
...
# ---------- 1. 场外基金净值增量(9/7 周一净值, 周二早盘全量可抓, QDII T+1~T+2) ----------
fund_map = {
...
# ---------- 2. 美股: 9/7(美东周一)劳动节休市, 9/4 收盘已归档, 尝试抓取(已存在自动 SKIP) ----------
