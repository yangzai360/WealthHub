# -*- coding: utf-8 -*-
"""2026-09-22 盘中档：新浪 hq 直连「两次调用拿全」（§3.84 推荐做法）
...
json.dump(out, open(os.path.join(ROOT, "data/processed/history/intraday_hq_20260922.json"), "w",
                    encoding="utf-8"), ensure_ascii=False, indent=1)
print("已保存 intraday_hq_20260922.json")
