# -*- coding: utf-8 -*-
"""周日(8/30)盘后档:追加周末事件到事件库(events-2026-08-30.json)"""
import json, os

EVENTS_PATH = '/Users/jieyang/Documents/WealthHub/data/processed/events/events-2026-08-30.json'
...
for i, n in enumerate(news, 1):
    events.append({
        ...
        "reference": {
            ...
            "confidence": None,
            "actual_ret_1d": None,
            "note": "周末事件,actual_ret_1d 待 8/31(周一)收盘回填",
            "ret_1d_ref": None,
        }
    })
