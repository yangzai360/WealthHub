# -*- coding: utf-8 -*-
"""
盘中行情抓取 (2026-09-08 13:45 档)
源: akshare 新浪源 + 天天基金源 (东财 push2 已被代理拦截, 不适用)
输出: data/processed/history/{indices,etf_intraday,fund_nav}.csv (增量) + intraday_20260908.json
"""
...
with open(os.path.join(HIST, "intraday_20260908.json"), "w", encoding="utf-8") as f:
