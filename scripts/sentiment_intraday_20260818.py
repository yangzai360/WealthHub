# -*- coding: utf-8 -*-
"""2026-08-18 盘中: DeepSeek 情绪标注 11 条盘中新增新闻"""
...
with open("/tmp/intraday_news_20260818.json", encoding="utf-8") as f:
    news = json.load(f)
...
print(f"\nsentiment-2026-08-18.json 共 {len(sent)} 条 (盘前18+盘中{len(results)})")
