# -*- coding: utf-8 -*-
"""盘前档 2026-09-10(周四) 行情抓取:场外基金净值增量(9/9周三净值, 周四早盘全量可抓, QDII T+1~T+2 应更新至9/8=XLV -2.52%兑现验证) + 美股(美东9/9周三收盘) + spot"""
...
# ---------- 1. 场外基金净值增量(9/9 周三净值, 周四早盘全量可抓; QDII 9/8 应出=XLV -2.52% 兑现验证) ----------
fund_map = {
...
# ---------- 2. 美股: 美东 9/9(周三)收盘, 北京时间 9/10 早间抓取 ----------
