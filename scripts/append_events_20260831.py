# -*- coding: utf-8 -*-
"""盘前档 2026-08-31：①事件库追加 17 条（actual_ret_1d 待 8/31 收盘回填）②8/30 周末事件留空检查
...
SENT_PATH = os.path.join(BASE, 'data/processed/news/sentiment-2026-08-31.json')
...
for i, s in enumerate(sentiments, 1):
    ...
    evs.append({
        ...
        "reference": {
            ...
            "confidence": None,
            "actual_ret_1d": None,
            "note": "盘前事件,actual_ret_1d 待 8/31(周一)收盘回填",
