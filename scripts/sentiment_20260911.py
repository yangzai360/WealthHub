# -*- coding: utf-8 -*-
"""盘前档 2026-09-11:DeepSeek 情绪标注(18条) 重试增强版——批次 7 条 + 每批最多 4 次重试 + 代码块剥离"""
import json, urllib.request, time

NEWS_PATH = '/Users/jieyang/Documents/WealthHub/data/processed/news/news-2026-09-11.json'
SENT_PATH = '/Users/jieyang/Documents/WealthHub/data/processed/news/sentiment-2026-09-11.json'
...
for n, r in zip(news, all_results):
    out.append({"date": "2026-09-11", "track": n["track"], "title": n["title"],
...
print(f'sentiment-2026-09-11.json 写入 {len(out)} 条')
for s in out:
