# -*- coding: utf-8 -*-
"""2026-09-11 盘后: DeepSeek 情绪标注盘后新增 8 条 (幂等, 2x4 分批 §3.67/§3.72 索引对齐)
只标注 sentiment 为空的条目; 结果写回 sentiment-2026-09-11.json"""
import json, os, time, urllib.request

BASE = '/Users/jieyang/Documents/WealthHub'
SENT_FILE = os.path.join(BASE, 'data/processed/news/sentiment-2026-09-11.json')

with open(os.path.join(BASE, 'data/processed/news/news-2026-09-11.json'), encoding='utf-8') as f:
    news = json.load(f)
