# -*- coding: utf-8 -*-
"""盘后档 2026-09-23：且慢长赢(LONG_WIN) playwright 兜底数据落库（§3.82：mtime 最新 + 校验 composition）
   ...
   - 快照写为 composition-2026-09-23-close.json（保留 13:46 盘中快照用于同日差分）
...
for prev in ('2026-09-22', '2026-09-23'):
