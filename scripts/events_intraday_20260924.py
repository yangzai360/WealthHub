...
"""2026-09-24 盘中档事件库处理：
  ...
  ④ 事件库 3/5/10 日窗口统计 → history/event_stats_intraday_20260924.json
...
out = {'date': TODAY, 'window': 'intraday', 'total_events': len(all_ev), 'today_events': len(ev),
       ...
       'note': '本档不回填（A股/港股 9/24 未收盘）；A股医药 3/5/10 日窗口以 399006 创业板指为代理（§3.90）'}
json.dump(out, open(os.path.join(HIST, f'event_stats_intraday_20260924.json'), 'w', encoding='utf-8'),
          ensure_ascii=False, indent=1)
print('\n已保存 event_stats_intraday_20260924.json')
