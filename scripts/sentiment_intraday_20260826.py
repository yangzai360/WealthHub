# -*- coding: utf-8 -*-
"""2026-08-26 盘中: DeepSeek 情绪标注 8 条盘中新增新闻"""
...
with open("/tmp/intraday_news_20260826.json", encoding="utf-8") as f:
    news = json.load(f)
...
print(f"\nsentiment-2026-08-26.json 共 {len(sent)} 条 (盘前{len(sent)-len(results)} + 盘中{len(results)})")
