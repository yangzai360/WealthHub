# -*- coding: utf-8 -*-
"""2026-08-19 盘中: 组合当日收益估算（场外基金用赛道ETF盘中涨跌近似）+ 赛道敞口"""
import json, os

base = "/Users/jieyang/Documents/WealthHub"

# 8/19 盘中涨跌（%）：场内ETF实时 + 指数盘中（13:45 抓取）
intraday = {
    # 场内ETF
    "513050": -0.09, "159928": -1.19, "512170": -1.98, "513180": -1.34,
    "159920": -0.13, "512880": -1.11, "512980": -2.98, "515180": 0.28,
    "159938": -1.47,
    # 指数
    "sh000001": -2.04, "sz399006": -4.77, "sh000932": -1.17,
    "HSTECH": -1.38, "HSI": -0.11,
    # 美股(8/18收盘, QDII 8/20-21 才兑现, 今日盘中按 0)
    "XLV": 0.0, "IYH": 0.0,
}
...
with open("/tmp/portfolio_intraday_20260819.json", "w", encoding="utf-8") as f:
    json.dump(out, f, ensure_ascii=False, indent=2)
print("\n已存 /tmp/portfolio_intraday_20260819.json")
