# -*- coding: utf-8 -*-
"""2026-08-17 盘中: DeepSeek 情绪标注 9 条盘中新增新闻"""
...
with open("/tmp/intraday_news_20260817.json", encoding="utf-8") as f:
    news = json.load(f)
...
print(f"\nsentiment-2026-08-17.json 共 {len(sent)} 条 (盘前12+盘中{len(results)})")
