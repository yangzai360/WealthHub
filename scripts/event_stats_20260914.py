# -*- coding: utf-8 -*-
"""盘前档 2026-09-14: 事件库统计——①1日样本 ②方向验证 ③3/5/10日事件后窗口统计
...
out = {
    'date': TODAY, 'as_of': '2026-09-13收盘回填',
...
json.dump(out, open(os.path.join(EV, f'event_stats_{TODAY.replace("-", "")}.json'), 'w', encoding='utf-8'),
          ensure_ascii=False, indent=1)
print(f'\nevent_stats_20260914.json 已保存')
