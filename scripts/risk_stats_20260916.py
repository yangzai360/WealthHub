# -*- coding: utf-8 -*-
"""2026-09-16 盘后: 链路累计/W38周累计/夏普比率/最大回撤（date 缺失时从文件名推导 §3.55）
本次为 30 个交易日样本 → 首次达到稳定口径"""
...
json.dump(out, open(os.path.join(HIST, 'risk_stats_20260916.json'), 'w', encoding='utf-8'), ensure_ascii=False, indent=1)
print('\n已保存 risk_stats_20260916.json')
