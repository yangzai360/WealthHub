# -*- coding: utf-8 -*-
"""盘后档 2026-08-31：生成 event_stats_20260831.json（与 events_fill_close 统计口径一致）"""
import json, os, glob
...
with open(os.path.join(BASE, 'data/processed/history/event_stats_20260831.json'), 'w', encoding='utf-8') as f:
    json.dump(out, f, ensure_ascii=False, indent=1)
print(f'event_stats_20260831.json 已生成：total={len(all_ev)} null={len(nulls)} 样本={tot_sample} 方向={tot_ok}/{tot_n}')
