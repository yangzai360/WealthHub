# -*- coding: utf-8 -*-
"""盘前档 2026-09-22(周二) 行情抓取:
1) 场外基金净值增量 —— 天天基金 F10 直连(§3.79); 判重 key = (code, nav_date) 二元组(§3.86)
   ★本档重点: 9/21 A股类净值盘后仅 13/23 出库 -> 本档兜底修正 9 只(002708/161616/000727/
     000248/000051/110020/002742 及 001551 等), 并复核 QDII 三只(000369/016280/164906)
     - QDII 9/21 净值对应美股 9/21 收盘? 否 —— QDII 净值日 = 美股对应交易日, 9/21 美股尚未收盘时
       不可得; 本档复核目标是 9/18 之后是否出 9/21(对应美股 9/19-9/21 无交易日, 应为 9/21 北京日)
2) 美股(美东 9/21 周一收盘 = 隔夜, ★新增交易日) —— XLV/IYH/QQQ/DIA/SPY + .IXIC/.DJI/.INX
3) 港股 hq 直连(9/21 收盘复核) + A股指数日线(9/21 收盘复核)
4) 且慢 pmdj 复测
...
# 9/21 盘后未出库的 9 只(待本档兜底) + QDII 三只(重点复核)
KEY_WATCH = {'002708', '161616', '000727', '000248', '000051', '110020', '002742'}
