# -*- coding: utf-8 -*-
"""盘中档 2026-09-23：且慢长赢(LONG_WIN) playwright 兜底数据落库（§3.82：mtime 最新 + 校验 composition）
   - plan 详情 → composition-2026-09-23.json + meta.json（含 nav_date_beijing）
...
本档 REST pmdj adjustments 仍空 body（连续第 89 日）→ playwright 兜底
"""
