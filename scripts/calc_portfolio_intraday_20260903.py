# -*- coding: utf-8 -*-
"""2026-09-03 盘中: 组合当日收益估算（9/2 收盘市值为基准 + 盘中实时涨跌）+ 赛道敞口"""
import json, os

base = "/Users/jieyang/Documents/WealthHub"

# 9/3 盘中涨跌（%）：场内ETF实时 + 指数盘中（13:44-13:45 抓取）
intraday = {
    # 场内ETF (13:45 实时)
    "513050": -1.05, "159928": -0.60, "512170": -0.30, "513180": -0.88,
    "159920": -0.13, "512880": 0.64, "512980": -0.36, "515180": 0.00,
    "159938": -0.16,
    # 指数 (13:45 实时)
    "sh000001": -0.17, "sz399006": -0.52, "sh000932": -0.46,
    "HSTECH": -0.99, "HSI": -0.33,
    # 美股(9/2 XLV +0.75% 于 9/4-5 兑现, 盘中估算按 0)
    "XLV": 0.0, "IYH": 0.0,
}

# 持仓基准: 9/2 收盘口径市值 (portfolio_preopen_20260903.json)
with open(os.path.join(base, "data/processed/history/portfolio_preopen_20260903.json"), encoding="utf-8") as f:
    preopen = json.load(f)
...
print(f"总资产(9/2收盘口径): {total:,.2f} 元")
print("\n== 赛道敞口(9/2收盘口径) ==")
...
with open("/tmp/portfolio_intraday_20260903.json", "w", encoding="utf-8") as f:
    json.dump(out, f, ensure_ascii=False, indent=2)
print("\n已存 /tmp/portfolio_intraday_20260903.json")
