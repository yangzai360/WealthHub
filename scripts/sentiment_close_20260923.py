# -*- coding: utf-8 -*-
"""2026-09-23 盘后档：DeepSeek 情绪标注（news-close-20260923.json → sentiment-2026-09-23.json）
...
NEWS_C = os.path.join(BASE, "data/processed/news/news-close-20260923.json")
...
5) 本条为「盘后收盘后」信息，须考虑其对次日（节前最后一个完整交易日 9/24）的传导。
