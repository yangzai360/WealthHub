# -*- coding: utf-8 -*-
"""盘后档 2026-08-28 收盘行情抓取：A股指数日线 / 港股spot(重试,失败走新闻补录) / 场内ETF / 个股 / 场外净值(含QDII 8/27) / 且慢pmdj复测(第35日)"""
...
# ---------- 2. 港股指数 spot（重试，列名"最新价"；盘后连续第13日预期失败） ----------
...
# ---------- 5. 场外基金净值（含 QDII 8/27 净值 T+1 兑现） ----------
fund_map = {
...
with open(os.path.join(HIST, 'close_20260828.json'), 'w', encoding='utf-8') as f:
    json.dump(out, f, ensure_ascii=False, indent=1)
print('\nDONE -> close_20260828.json')
