# -*- coding: utf-8 -*-
"""2026-08-18 盘中: 组合当日收益估算（场外基金用赛道ETF盘中涨跌近似）+ 赛道敞口"""
import json, os

base = "/Users/jieyang/Documents/WealthHub"

# 8/18 盘中涨跌（%）：场内ETF实时 + 指数盘中（13:45 抓取）
intraday = {
    # 场内ETF
    "513050": -0.63, "159928": 0.75, "512170": 0.00, "513180": -1.82,
    "159920": -0.53, "512880": -1.46, "512980": -2.23, "515180": 0.57,
    "159938": -0.44,
    # 指数
    "sh000001": -0.25, "sz399006": -1.49, "sh000932": 1.01,
    "HSTECH": -1.97, "HSI": -0.61,
    # 美股(8/17收盘, QDII滞后反映)
    "XLV": -0.19, "IYH": -0.07,
}
...
with open("/tmp/portfolio_intraday_20260818.json", "w", encoding="utf-8") as f:
    json.dump(out, f, ensure_ascii=False, indent=2)
print("\n已存 /tmp/portfolio_intraday_20260818.json")
