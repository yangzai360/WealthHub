# -*- coding: utf-8 -*-
"""2026-09-15 盘前档情绪标注（DeepSeek v4-flash, max_tokens=8000）
分批标注（每批 7 条，共 4 批），results key 用全局偏移（§3.72 教训）
"""
...
with open(os.path.join(NEWS, f'sentiment-{DATE}.json'), 'w', encoding='utf-8') as f:
    json.dump({'date': DATE, 'window': '2026-09-13 18:00 - 2026-09-15 07:30 (盘前)', 'items': out},
