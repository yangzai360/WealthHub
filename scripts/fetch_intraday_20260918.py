# -*- coding: utf-8 -*-
"""2026-09-18 盘中档：新浪 hq 直连「两次调用拿全」（§3.84 推荐做法）
...
BOARDS = [("sh000933", "中证医药"), ("sz399989", "中证医疗"), ("sz399997", "中证白酒"),
          ("sh000827", "中证环保"), ("sh000934", "中证金融"), ("sh000949", "中证银行"),
          ("sh000913", "300医药"), ("sz399975", "证券公司")]
...
json.dump(out, open(os.path.join(ROOT, "data/processed/history/intraday_hq_20260918.json"), "w",
                    encoding="utf-8"), ensure_ascii=False, indent=1)
print("已保存 intraday_hq_20260918.json")
