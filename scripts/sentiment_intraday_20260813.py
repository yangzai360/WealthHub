# -*- coding: utf-8 -*-
"""2026-08-13 盘中: DeepSeek 情绪标注 7 条盘中新增新闻"""
...
with open("/tmp/intraday_news_20260813.json", encoding="utf-8") as f:
    news = json.load(f)
...
- "reason": 30字内标注理由（结合持仓赛道：大消费/A股医药/美股标普医药/恒生科技）
...
print(f"\nsentiment-2026-08-13.json 共 {len(sent)} 条 (盘前14+盘中{len(results)})")
