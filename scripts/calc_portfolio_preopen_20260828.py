# -*- coding: utf-8 -*-
"""盘前档 2026-08-28：组合估值重算（8/27 收盘真实净值全量）+ 赛道占比 + 集中度检查
...
# ---------- 个股 8/26 收盘 ----------
STOCK_PRICE = {"002410": 8.79, "600438": 11.90}   # 广联达 8.79(0.00%)、通威 11.90(-0.92%)
...
print("\n参考: 8/27 盘后重估总资产 388,170.17（组合 -0.12% 已确认）")
...
out = {"date": "2026-08-28", "as_of": "2026-08-27收盘", "snap_total": round(snap_total, 2),
       ...
       "detail": detail}
with open(os.path.join(HIST, "portfolio_preopen_20260828.json"), "w", encoding="utf-8") as f:
    json.dump(out, f, ensure_ascii=False, indent=1)
print("\n已保存 portfolio_preopen_20260828.json")
