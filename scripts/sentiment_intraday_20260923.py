# -*- coding: utf-8 -*-
"""2026-09-23 盘中档：DeepSeek 情绪标注（news-intraday-20260923.json → sentiment-2026-09-23.json）
...
NEWS_I = os.path.join(BASE, "data/processed/news/news-intraday-20260923.json")
NEWS_D = os.path.join(BASE, "data/processed/news/news-2026-09-23.json")
SENT = os.path.join(BASE, "data/processed/news/sentiment-2026-09-23.json")
WIN = "盘中(07:30-13:30)"
...
if not isinstance(doc, dict):
    doc = {"date": "2026-09-23", "window": WIN, "items": doc}
old = doc.get('items', [])
...
print(f"\nsentiment-2026-09-23.json: {len(old)} -> {doc['count']} 条")

# news-2026-09-23.json 追加（保留原字段，补 sentiment 结论）
...
print(f"news-2026-09-23.json: {len(news)} 条")
