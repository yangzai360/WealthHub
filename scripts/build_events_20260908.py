# -*- coding: utf-8 -*-
"""盘前档 2026-09-08: 新建 events-2026-09-08.json (14 条) + 历史事件库匹配统计
9/7 34 条已全量回填, 全库 0 留空; 9/8 新增 14 条 actual_ret_1d 待今日收盘回填"""
import json, os, glob
from collections import defaultdict

BASE = '/Users/jieyang/Documents/WealthHub'
EVENTS_DIR = os.path.join(BASE, 'data/processed/events')
NEWS_FILE = os.path.join(BASE, 'data/processed/news/news-2026-09-08.json')
...
print(f"events-2026-09-08.json 新建 {len(new_events)} 条")
for e in new_events:
    print(f"  {e['id']} [{e['track']}] {e['sentiment']}{e['score']} | {e['title'][:38]}")

print("\n=== 历史事件 1日收益统计（按赛道, 截至 9/7 收盘回填） ===")
