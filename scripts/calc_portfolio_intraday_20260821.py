# -*- coding: utf-8 -*-
"""2026-08-21 盘中: 组合当日收益估算（场外基金用赛道ETF盘中涨跌近似）+ 赛道敞口"""
import json, os

base = "/Users/jieyang/Documents/WealthHub"

# 8/21 盘中涨跌（%）：场内ETF实时 + 指数盘中（13:41 抓取）
intraday = {
    # 场内ETF
    "513050": -1.59, "159928": -1.64, "512170": -3.06, "513180": -0.50,
    "159920": 0.26, "512880": -0.19, "512980": -1.23, "515180": 0.00,
    "159938": -3.35,
    # 指数
    "sh000001": -0.11, "sz399006": 1.07, "sh000932": -1.62,
    "HSTECH": 0.55, "HSI": 0.74,
    # 美股(8/20收盘, QDII 8/24-25 才兑现, 今日盘中按 0)
    "XLV": 0.0, "IYH": 0.0,
}
...
with open("/tmp/portfolio_intraday_20260821.json", "w", encoding="utf-8") as f:
    json.dump(out, f, ensure_ascii=False, indent=2)
print("\n已存 /tmp/portfolio_intraday_20260821.json")
