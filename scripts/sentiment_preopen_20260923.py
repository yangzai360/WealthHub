# -*- coding: utf-8 -*-
"""2026-09-23 盘前档：DeepSeek v4-flash 情绪标注（窗口 9/20 18:00 - 9/21 07:30，全量标注）
⚠️ §3.88：必须为每条 item 写 `window` 字段；§3.82：差集比对用 title[:60]；§3.72：全局 idx 连续编号
"""
import json, os, time, urllib.request

BASE = '/Users/jieyang/Documents/WealthHub'
NEWS = os.path.join(BASE, 'data/processed/news/news-2026-09-23.json')
SENT = os.path.join(BASE, 'data/processed/news/sentiment-2026-09-23.json')
WINDOW = '盘前(9/22 18:00-9/23 07:30)'
...
if os.path.exists(SENT):
    ...
    sent = {'date': '2026-09-23', 'window': WINDOW, 'items': []}
