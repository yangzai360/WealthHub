# -*- coding: utf-8 -*-
"""2026-08-20 盘中: 事件库追加 11 条盘中新闻 (id 019-029) + 历史匹配统计"""
import json, os, glob

BASE = '/Users/jieyang/Documents/WealthHub'
EVENTS_DIR = os.path.join(BASE, 'data/processed/events')
SENT_FILE = os.path.join(BASE, 'data/processed/news/sentiment-2026-08-20.json')
OUT_FILE = os.path.join(EVENTS_DIR, 'events-2026-08-20.json')
...
print(f"events-2026-08-20.json 共 {len(combined)} 条 (盘前{len(existing)} + 盘中{len(new_events)})")
for e in new_events:
