# -*- coding: utf-8 -*-
"""2026-09-17 盘后：抓取场外基金净值（天天基金 F10 直连，§3.79）+ 合并进 close_20260916.json"""
...
print('\n净值日分布(>=9/11):', dict(c))
t16 = [n for n in navs if n['nav_date'] == TODAY]
print(f'\n已出 9/16 净值 {len(t16)} 只:')
for n in sorted(t16, key=lambda x: -(x['pct'] or 0)):
