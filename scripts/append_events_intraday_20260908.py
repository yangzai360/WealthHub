# -*- coding: utf-8 -*-
"""2026-09-08 盘中: 事件库追加 8 条盘中新闻 (id 015-022) + 历史匹配统计"""
import json, os, glob
from collections import defaultdict

BASE = '/Users/jieyang/Documents/WealthHub'
EVENTS_DIR = os.path.join(BASE, 'data/processed/events')
SENT_FILE = os.path.join(BASE, 'data/processed/news/sentiment-2026-09-08.json')
OUT_FILE = os.path.join(EVENTS_DIR, 'events-2026-09-08.json')
...
# 盘中 8 条手动归类赛道（track 用赛道名，禁止 category 名；§3.64: 按『实际影响板块』归类）
TRACK_MAP = {
    "A股午评（9/8）": "宏观",
    "港股午评（9/8）": "恒生科技",
    "恒生科技13:45实时": "恒生科技",
...
print(f"events-2026-09-08.json 共 {len(combined)} 条 (盘前{len(existing)} + 盘中{len(new_events)})")
for e in new_events:
