# -*- coding: utf-8 -*-
"""盘后档 2026-08-17 收盘行情抓取：A股指数日线 / 港股 spot(重试,失败走新闻补录) / 场内ETF / 个股 / 场外净值 / 且慢pmdj复测(第9日)"""
...
with open(os.path.join(HIST, 'close_20260817.json'), 'w', encoding='utf-8') as f:
    json.dump(out, f, ensure_ascii=False, indent=1)
print('\nDONE -> close_20260817.json')
