# -*- coding: utf-8 -*-
"""2026-09-25 盘前档：DeepSeek v4-flash 情绪标注（窗口 9/23 18:00 - 9/24 07:30，全量标注）
...
NEWS = os.path.join(BASE, 'data/processed/news/news-2026-09-25.json')
SENT = os.path.join(BASE, 'data/processed/news/sentiment-2026-09-25.json')
WINDOW = '盘前(9/24 18:00-9/25 07:30)'
...
if os.path.exists(SENT):
    ...
    sent = {'date': '2026-09-25', 'window': WINDOW, 'items': []}
