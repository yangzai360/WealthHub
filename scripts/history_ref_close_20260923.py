# -*- coding: utf-8 -*-
"""2026-09-23 盘后档：历史相似事件匹配（品类+赛道+关键词 Jaccard → Top3）→ 3/5/10 日窗口
...
json.dump(out, open(os.path.join(HIST, 'history_ref_20260923_close.json'), 'w', encoding='utf-8'),
          ensure_ascii=False, indent=1)
print('\nSAVED history_ref_20260923_close.json')
