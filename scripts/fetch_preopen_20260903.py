# -*- coding: utf-8 -*-
"""盘前档 2026-09-03(周四) 行情抓取：场外基金净值增量(9/2周三净值, 周四早盘全量可抓, QDII T+1~T+2至9/1) + 美股9/2(美东周三)收盘新抓 + ETF 9/2收盘已归档(9/2盘后)无需重抓"""
...
# ---------- 1. 场外基金净值增量（9/2 周三净值，周四早盘全量可抓，QDII T+1~T+2 至 9/1） ----------
fund_map = {
