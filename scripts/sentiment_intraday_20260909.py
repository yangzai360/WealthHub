# -*- coding: utf-8 -*-
"""2026-09-09 盘中: DeepSeek 情绪标注 8 条盘中新增新闻 (2批×4条; 标题截断≤200字符规避空响应)"""
...
with open("/tmp/intraday_news_20260909.json", encoding="utf-8") as f:
    news = json.load(f)
...
sent_path = os.path.join(BASE, "data/processed/news/sentiment-2026-09-09.json")
...
print(f"\nsentiment-2026-09-09.json 共 {len(sent)} 条 (盘前{len(sent)-added} + 盘中{added})")
