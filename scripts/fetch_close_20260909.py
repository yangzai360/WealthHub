# -*- coding: utf-8 -*-
"""2026-09-09 盘后档行情抓取: A股指数日线收盘/港股hq直取/场内ETF收盘/场外基金当日净值+QDII补更/个股真实收盘
输出 data/processed/history/close_20260909.json"""
...
# ---------- 2. 港股收盘（hq.sinajs.cn 直取, 20:00 与新华社通稿等价 §3.62） ----------
def fetch_hq():
