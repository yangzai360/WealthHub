# -*- coding: utf-8 -*-
"""2026-09-08 盘后: close_20260908.json -> indices.csv/etf_intraday.csv/fund_nav.csv 增量写入
...
nav_rows = [['2026-09-08', r['code'], r['name'], r['nav_date'], r['nav'], r['pct'] if r['pct'] is not None else '']
...
with open(os.path.join(HIST, 'indices.csv'), encoding='utf-8-sig') as f:
    lines = f.readlines()
today_rows = [l.strip() for l in lines if '2026-09-08' in l and '收盘20:00' in l]
