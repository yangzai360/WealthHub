# -*- coding: utf-8 -*-
"""2026-09-04 盘中: DeepSeek 情绪标注 8 条盘中新增新闻 (分2批, 每批≤7 规避空响应)"""
...
with open("/tmp/intraday_news_20260904.json", encoding="utf-8") as f:
    news = json.load(f)
...
sent_path = os.path.join(BASE, "data/processed/news/sentiment-2026-09-04.json")
...
print(f"\nsentiment-2026-09-04.json 共 {len(sent)} 条 (盘前{len(sent)-added} + 盘中{added})")
