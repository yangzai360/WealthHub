# -*- coding: utf-8 -*-
"""2026-09-21 盘前档：DeepSeek v4-flash 情绪标注（窗口 9/20 18:00 - 9/21 07:30，全量标注）
...
WINDOW = '盘前(9/20 18:00-9/21 07:30)'
...
if os.path.exists(SENT):
    ...
    sent = {'date': '2026-09-21', 'window': WINDOW, 'items': []}
...
print(f"\n盘前新增 {len(add)} 条：利多 {np_} / 利空 {nn_} / 中性 {nu_}，均值强度 {sum(x['strength'] for x in add)/len(add):.1f}")
