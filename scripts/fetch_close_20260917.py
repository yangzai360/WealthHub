# -*- coding: utf-8 -*-
"""2026-09-17 盘后：抓取收盘行情（新浪 hq 直连，两次调用拿全，§3.84/§3.87 推荐做法）
注意 §3.87：不请求 sh000922（中证红利，返回空），红利方向用持仓 sh515180 代理；
pct() 加零值守卫，写入前剔除「现价=0/名称空」条目。
本次新增 sh000934（中证金融，用于 001469 金融地产联接代理，§3.87）。
"""
...
CODES_1 = ['sh000001', 'sz399001', 'sz399006', 'sh000300', 'sh000932', 'sh000933',
           'sz399989', 'sz399997', 'sh000688', 'sh000827', 'sh000934',
