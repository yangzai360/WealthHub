# -*- coding: utf-8 -*-
"""盘后档 2026-08-13 收盘行情抓取：A股指数日线 / 港股 spot / 场内ETF / 个股 / 场外净值 / 美股(XLV/IYH 8/12回填) / 且慢pmdj复测(第4日)"""
...
# ---------- 7. 且慢 pmdj 复测（第4日，盘中已用 playwright 兜底） ----------
qieman = {}
pmdj_urls = {
...
with open(os.path.join(HIST, 'close_20260813.json'), 'w', encoding='utf-8') as f:
    json.dump(out, f, ensure_ascii=False, indent=1)
print('\nDONE -> close_20260813.json')
