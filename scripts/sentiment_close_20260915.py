# -*- coding: utf-8 -*-
"""2026-09-15 盘后档：DeepSeek v4-flash 情绪标注（盘后窗口 13:30-20:00 新增 18 条）
注意 §3.82：差集比对统一用 title[:60] 截断口径"""
import json, os, time, urllib.request

BASE = '/Users/jieyang/Documents/WealthHub'
NEWS = os.path.join(BASE, 'data/processed/news/news-2026-09-15.json')
SENT = os.path.join(BASE, 'data/processed/news/sentiment-2026-09-15.json')
WINDOW = '盘后(13:30-20:00)'
