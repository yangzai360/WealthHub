...
"""2026-09-22 盘中档事件库处理：
  ...
  ④ 事件库 3/5/10 日窗口统计 → history/event_stats_intraday_20260922.json
...
json.dump(out, open(os.path.join(HIST, f'event_stats_intraday_20260922.json'), 'w', encoding='utf-8'),
          ensure_ascii=False, indent=1)
print('\n已保存 event_stats_intraday_20260922.json')
